...
namespace gd
{
	AllocType alloc = reinterpret_cast<AllocType>(GetProcAddress(LoadLibraryA("MSVCR120.DLL"), "??2@YAPAXI@Z"));
	DeallocType dealloc = reinterpret_cast<DeallocType>(GetProcAddress(LoadLibraryA("MSVCR120.DLL"), "??3@YAXPAX@Z"));
