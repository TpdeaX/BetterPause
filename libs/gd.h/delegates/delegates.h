...
namespace gd {
    ...
    class GDH_DLL AppDelegate : cocos2d::CCApplication {
    public:
        virtual bool applicationDidFinishLaunching() {
            reinterpret_cast<void(__thiscall*)(AppDelegate*)>(
                base + 0x3cbb0
                )(this);
        }
        ...
        virtual void willSwitchToScene(cocos2d::CCScene* scene) {
            reinterpret_cast<void(__thiscall*)(AppDelegate*, cocos2d::CCScene*)>(
                base + 0x3d690
                )(this, scene);
        }
        ...
        bool musicTest() {
           return reinterpret_cast<bool(__thiscall*)(AppDelegate*)>(
                base + 0x3d580
                )(this);
        }
        void pauseGame() {
            reinterpret_cast<bool(__thiscall*)(AppDelegate*)>(
                base + 0x3d3e0
                )(this);
        }
        void resumeSound() {
