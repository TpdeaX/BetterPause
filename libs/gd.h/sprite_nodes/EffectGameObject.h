...
namespace gd {
            ...
            void updateLabel() {
                ...
                if (label) {
                    switch (this->m_nObjectID) {
                        ...
                        //   color,    pulse
                        case 899: case 1006: {
                            int target = this->m_nObjectID == 1006 ? m_nTargetGroupID : m_targetColorID;
                            if (target > 999) {
    ...
    public:
        static StartPosObject* create() {
            return reinterpret_cast<StartPosObject * (__thiscall*)()>(
                base + 0x25AA40
                )();
        }
        void setSettings(LevelSettingsObject* stgs) {
            reinterpret_cast<void(__thiscall*)(StartPosObject*, LevelSettingsObject*)>(
                base + 0x25AB80
                )(this, stgs);
        }

        LevelSettingsObject* m_levelSettings; //0x558
    };

    class GDH_DLL RingObject : public EffectGameObject {
        bool create(char const* c) {
            return reinterpret_cast<bool(__thiscall*)(char const*)>(
                base + 0x252220
                )(c);
        }
        bool init(char const* c) {
            return reinterpret_cast<bool(__thiscall*)(char const*)>(
                base + 0x2522E0
                )(c);
        }
        ...
        virtual void setRotation(float angle) {
            reinterpret_cast<void(__thiscall*)(float)>(
                base + 0x252640
                )(angle);
        }
        ...
        virtual void customObjectSetup(std::map<std::string, std::string>& map) {
            reinterpret_cast<void(__thiscall*)(std::map<std::string, std::string>&)>(
                base + 0x2526A0
                )(map);
        }
        virtual std::string getSaveString() {
            return reinterpret_cast<std::string(__thiscall*)()>(
                base + 0x2527F0
                )();
        }
        ...
        virtual void setRScale(float rscale) {
            reinterpret_cast<void(__thiscall*)()>(
                base + 0x2525D0
                )();
        }
        virtual void triggerActivated(float duration) {
            reinterpret_cast<void(__thiscall*)()>(
                base + 0x252350
                )();
        }
