...
namespace gd {
	...
	public:
		...
		void playBackgroundMusic(std::string path, bool fade, bool paused) {
			reinterpret_cast<void(__thiscall*)(GameSoundManager*, std::string, bool, bool)>(base + 0x252b0)(this, path, fade, paused);
		}
		// penis
		...
		void playBackgroundMusic_what(bool idk, std::string music) {
			reinterpret_cast<void(__thiscall*)(GameSoundManager*, bool, std::string)>(base + 0x4bf00)(this, idk, music);
		}
	};
}
